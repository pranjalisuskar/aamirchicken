...
const Trackorderviewmodal = ({ isOpen, toggle, shop }) => {
  return (
    <div>  <Modal isOpen={isOpen} toggle={toggle} size='lg' centered>
    <ModalHeader toggle={toggle}>Track-Order Details</ModalHeader>
    <ModalBody>
      <form
        className="shopform"
...
export default Trackorderviewmodal