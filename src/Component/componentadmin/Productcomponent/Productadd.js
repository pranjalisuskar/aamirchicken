...
const ProductAdd = () => {
  ...
  return (
    <div
      className="container shopform-container"
      style={{ marginBottom: "70px", width: "1000" }}
    >
      <h2
      ...
      >
        <div className="row">
          ...
          <div
            className="form-group col-md-6 custom-input"
            // style={{ margin: "20px 40px", padding: "10px" }}
          >
            <button
              type="submit"
              className="submit-button"
              style={{
                width: "150%", // Makes it responsive inside the parent container
                maxWidth: "500px", // Restricts maximum width
                height: "40px",
                // padding: "10px 20px", // Adds inner spacing for better button aesthetics
