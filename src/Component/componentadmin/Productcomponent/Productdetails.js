...
function Productdetails() {
  ...
  const shop = shopsData[productId];
    ...
    <div className="container mt-5">
      ...
      <div className="products-section">
        ...
        <div className="products">
          {/* Check if shop.products exists and is an array before calling .map() */}
          {shop.products && Array.isArray(shop.products) ? (
      ...
      <Modal
        ...
        className="bottom-modal" // Custom class to position modal at the bottom
